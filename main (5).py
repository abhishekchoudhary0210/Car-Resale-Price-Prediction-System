...
# 2. year integer
year = col1.slider(
    'Enter the year when the car was manufactured e.g: 2005', 
    1980, 2020, 2005,
...
# prj_info = """
# Here you can predict used car 🚙 prices by providing information like car brand, model, mileage, and other details.
# Click the predict button to get an estimated price. The model uses RandomForest Regressor which provides accurate results.
# """
# st.write(prj_info)
